package project.fashionecommerce.backend.fashionecommerceproject.service.token;
...
public class TokenCommandService {
    ...
    public Token save(String userId, Long durationMs) {
        ...
        tokenEntity.setExpiryDateTime(LocalDateTime.now().plusMinutes(durationMs/1000));
